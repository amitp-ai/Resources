...
class Tree(object):
	...
	class Position(object):
		...
		def __eq__(self,other):
			...
			raise NotImplementedError('xxxxxxmust be implemented by subclass')
...
str_to_check8 = '.lib \'..\\lib\\ltspice\\'
print(str_to_check8 in '.lib \'..\\lib\\ltspice\\bcd035_5v_simetrix_corners.lib\' mos')
