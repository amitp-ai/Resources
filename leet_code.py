...
### General Stuff on Trees, Dijsktra, etc #####
...
### /END General Stuff on Trees, Dijsktra, etc #####
...
# To Do:
# 1. Balanced Binary Search Tree (red and black tree)
# 2. Do decoding problem (on firecode) without using tree search
